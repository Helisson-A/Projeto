...
route.register(r'CadastroGeral', registerViewSet,basename="registro")
route.register(r'CadastroPet', PetViewSet,basename="PetRegistro")
route.register(r'MensagemPet', PetMensagemViewSet, basename='Mensagens')
